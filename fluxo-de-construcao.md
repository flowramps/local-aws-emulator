...
> Desenhado com [`diagrams`](https://diagrams.mingrammer.com/) sobre o pacote oficial
> de ícones de arquitetura da AWS. Fonte: [`docs/arquitetura_aws.py`](docs/arquitetura_aws.py) — `make diagram` regenera o PNG.
